...
const Footer = () => {
    return (
        <footer className="flex items-center justify-between gap-4 px-4 lg:px-44 py-3">
            ...
            {/* Copyright */}
            <p className="flex-1 border-l border-gray-100 pl-4 max-sm:hidden">
                &copy; {new Date().getFullYear()} @adityaranjan | All rights reserved.
            </p>
            ...
            <div className="flex gap-3">
                {FOOTER_CONSTANTS.map((item, index) => (
                    ...
                    >
                        <img src={item.logo} alt="social" width={32} />
                    </a>
                ))}
            </div>
        </footer>
